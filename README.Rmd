...
In some cases, tables may include coordinates as numeric columns. If this is the case, you can create a bounding box filter condition using the following format:
